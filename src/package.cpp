...
//constructor
Package::Package(const std::string senderName_, const std::string recipientName_, const std::string senderAddress_, const std::string recipientAddress_, float weight_){
